...
Release bookkeeping is also explicit: generated repositories keep a root `CHANGELOG.md`, but agents should ask the user before editing changelogs or version numbers.
