...
- `AGENTS.md`: operating rules for agents working in the repository.
...
- `features/generated/`: validation and review artifacts.
- `features/tech-debt-tracker.md`: deferred work.

## Important Workflow Rule

The scaffold is intentionally generic, but it already encodes the requirement that non-trivial implementation must be followed by an independent validation-subagent pass.
